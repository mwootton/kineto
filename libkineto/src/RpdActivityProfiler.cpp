...
struct RpdActivityProfiler::RpdActivityProfilerPrivate {
  ...
  void ensureSchema() {
    sqlite3* db = nullptr;
    int rc = sqlite3_open(rpdFilePath.c_str(), &db);
    if (rc != SQLITE_OK) {
      LOG(WARNING) << "Failed to open RPD file for schema: " << rpdFilePath;
    ...
    if (sqlite3_step(stmt) == SQLITE_ROW) {
      hasSchema = sqlite3_column_int(stmt, 0) > 0;
    }
    ...
    if (!hasSchema) {
      ...
      if (!hasSchema) {
        static const char* schema =
            "CREATE TABLE IF NOT EXISTS \"rocpd_string\" "
            "(\"id\" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "
            "\"string\" varchar(4096) NOT NULL);"
            "CREATE TABLE IF NOT EXISTS \"rocpd_ustring\" "
            "(\"id\" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "
            "\"string\" varchar(4096) NOT NULL);"
            ...
            "\"apiName_id\" bigint NOT NULL REFERENCES \"rocpd_string\" (\"id\") DEFERRABLE INITIALLY DEFERRED, "
            "\"category_id\" bigint NOT NULL REFERENCES \"rocpd_string\" (\"id\") DEFERRABLE INITIALLY DEFERRED, "
            "\"domain_id\" bigint NOT NULL REFERENCES \"rocpd_string\" (\"id\") DEFERRABLE INITIALLY DEFERRED, "
            "\"args_id\" bigint NOT NULL REFERENCES \"rocpd_ustring\" (\"id\") DEFERRABLE INITIALLY DEFERRED);"
            "CREATE TABLE IF NOT EXISTS \"rocpd_op\" "
            "(\"id\" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "
            "\"gpuId\" integer NOT NULL, \"queueId\" integer NOT NULL, "
            "\"sequenceId\" integer NOT NULL, "
            "\"start\" integer NOT NULL, \"end\" integer NOT NULL, "
            "\"description_id\" bigint NOT NULL REFERENCES \"rocpd_string\" (\"id\") DEFERRABLE INITIALLY DEFERRED, "
            "\"opType_id\" bigint NOT NULL REFERENCES \"rocpd_string\" (\"id\") DEFERRABLE INITIALLY DEFERRED);"
            "CREATE TABLE IF NOT EXISTS \"rocpd_api_ops\" "
            "(\"id\" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "
            "\"api_id\" bigint NOT NULL REFERENCES \"rocpd_api\" (\"id\") DEFERRABLE INITIALLY DEFERRED, "
            "\"op_id\" bigint NOT NULL REFERENCES \"rocpd_op\" (\"id\") DEFERRABLE INITIALLY DEFERRED);"
            "CREATE TABLE IF NOT EXISTS \"rocpd_kernelapi\" "
            "(\"api_ptr_id\" bigint NOT NULL PRIMARY KEY REFERENCES \"rocpd_api\" (\"id\") DEFERRABLE INITIALLY DEFERRED, "
            "\"stream\" varchar(18) NOT NULL, "
            "\"gridX\" integer NOT NULL, \"gridY\" integer NOT NULL, \"gridZ\" integer NOT NULL, "
            "\"workgroupX\" integer NOT NULL, \"workgroupY\" integer NOT NULL, \"workgroupZ\" integer NOT NULL, "
            "\"groupSegmentSize\" integer NOT NULL, \"privateSegmentSize\" integer NOT NULL, "
            "\"kernelName_id\" bigint NOT NULL REFERENCES \"rocpd_string\" (\"id\") DEFERRABLE INITIALLY DEFERRED);"
            "CREATE TABLE IF NOT EXISTS \"rocpd_copyapi\" "
            "(\"api_ptr_id\" bigint NOT NULL PRIMARY KEY REFERENCES \"rocpd_api\" (\"id\") DEFERRABLE INITIALLY DEFERRED, "
            "\"stream\" varchar(18) NOT NULL, "
            "\"size\" integer NOT NULL, \"width\" integer NOT NULL, \"height\" integer NOT NULL, "
            "\"kind\" integer NOT NULL, "
            "\"dst\" varchar(18) NOT NULL, \"src\" varchar(18) NOT NULL, "
            "\"dstDevice\" integer NOT NULL, \"srcDevice\" integer NOT NULL, "
            "\"sync\" bool NOT NULL, \"pinned\" bool NOT NULL);"
            "CREATE TABLE IF NOT EXISTS \"rocpd_metadata\" "
            "(\"id\" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "
            "\"tag\" varchar(4096) NOT NULL, \"value\" varchar(4096) NOT NULL);"
            "CREATE TABLE IF NOT EXISTS \"rocpd_monitor\" "
            "(\"id\" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "
            "\"deviceType\" varchar(16) NOT NULL, \"deviceId\" integer NOT NULL, "
            "\"monitorType\" varchar(16) NOT NULL, "
            "\"start\" integer NOT NULL, \"end\" integer NOT NULL, "
            "\"value\" varchar(255) NOT NULL);"
            "CREATE TABLE IF NOT EXISTS \"rocpd_counter\" "
            "(\"id\" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "
            "\"value\" real NOT NULL, "
            "\"op_id\" bigint NOT NULL REFERENCES \"rocpd_op\" (\"id\") DEFERRABLE INITIALLY DEFERRED, "
            "\"name_id\" bigint NOT NULL REFERENCES \"rocpd_string\" (\"id\") DEFERRABLE INITIALLY DEFERRED);"
            "CREATE TABLE IF NOT EXISTS \"rocpd_stackframe\" "
            "(\"id\" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "
            "\"api_ptr_id\" bigint NOT NULL REFERENCES \"rocpd_api\" (\"id\") DEFERRABLE INITIALLY DEFERRED, "
            "\"depth\" integer NOT NULL, "
            "\"name_id\" bigint NOT NULL REFERENCES \"rocpd_string\" (\"id\") DEFERRABLE INITIALLY DEFERRED);"
            "CREATE INDEX IF NOT EXISTS \"rocpd_strin_string_c7b9cd_idx\" ON \"rocpd_string\" (\"string\");"
            "CREATE INDEX IF NOT EXISTS \"rocpd_ustri_string_84d4a7_idx\" ON \"rocpd_ustring\" (\"string\");";

        char* errMsg = nullptr;
        rc = sqlite3_exec(db, schema, nullptr, nullptr, &errMsg);
        if (rc != SQLITE_OK) {
          LOG(WARNING) << "Failed to create RPD schema: "
